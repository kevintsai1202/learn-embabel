...
**來源網址**: [https://www.danvega.dev/blog/embabel-mcp-servers-and-tools](https://www.danvega.dev/blog/embabel-mcp-servers-and-tools)
**來源網站**: danvega.dev
...
[github.com/danvega/blog-agent](https://github.com/danvega/blog-agent)

[View Repo](https://github.com/danvega/blog-agent)
...
## [Adding Logging Personalities](#adding-logging-personalities)
...
## [Defining the Domain Types](#defining-the-domain-types)
...
## [Creating a Custom Tool for Reading Time](#creating-a-custom-tool-for-reading-time)
...
## [Wiring the Tool into an Action](#wiring-the-tool-into-an-action)
...
## [Adding an MCP Server for Web Research](#adding-an-mcp-server-for-web-research)
...
## [Updating the Goal](#updating-the-goal)
...
## [Prompt Contributors and Personas](#prompt-contributors-and-personas)
...
## [What Makes This Approach Compelling](#what-makes-this-approach-compelling)
